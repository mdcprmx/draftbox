...
int main(int argc, char *argv[]) {
                 ...
                 // name btw) do:
  {
    ...
    scenario_file_doesnt_exist(
        filename_arg);  // if filename is written wrong (or it doesnt exist),
                        // prints error
  ...
  // Use case Two - return stdin to stdout (text that user wrote in terminal
  // returns to terminal) // 4.2 - if no arguments are present.
  else {
